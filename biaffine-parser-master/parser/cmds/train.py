...
class Train(CMD):
    ...
    def add_subparser(self, name, parser):
        ...
        subparser.add_argument('--ftrain', default='data/ptb/hintrain.conllx',
                               help='path to train file')
        subparser.add_argument('--fdev', default='data/ptb/hindev.conllx',
                               help='path to dev file')
        subparser.add_argument('--ftest', default='data/ptb/hintest.conllx',
                               help='path to test file')
        subparser.add_argument('--fembed', default='data/hin.txt',
